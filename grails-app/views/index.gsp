...
<article>
    ...
    <section>
        ...
        <p>Меня зовут Дима Тихвинский, я — немного лохматый веб-разработчик и джава-программист. Кроме джавы я иногда использую groovy и php.</p>
        <p>Я немного умею играть на клавишных и изредка занимаюсь этим на своих Casio CTK-900 и microkorg. В основном импровизирую, просто для расслабления.</p>
        <p>Кроме музыки, я увлекаюсь психологией и соционикой; я весьма серьёзно отношусь к этим гуманитарным наукам и рассматриваю их прежде всего с практической стороны.</p>
        <p>Помимо всего этого, я — студент <a href="http://ifmo.ru">ИТМО</a>, учусь на 3 курсе по специальности <a href="http://www.ifmo.ru/spec/25/spec_25.htm">«Информационные системы и технологии»</a>. Иногда я получаю удовольствие и от этого.</p>
    </section>
</article>
...
<article>
    <header><h1>Кажется, тут ещё блог был!</h1></header>
    <section>
        <p>В общем-то, блога у меня теперь нет.</p>
