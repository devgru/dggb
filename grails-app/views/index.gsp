...
<article>
    ...
    <section>
        ...
        <p>Меня зовут Дима Тихвинский, я — немного лохматый веб-разработчик и java-программист. Кроме джавы я иногда использую groovy и php.</p>
        <p>Я немного умею играть на клавишных и изредка занимаюсь этим на своих Casio CTK-900 и microkorg. Чуть позже планирую написать midi-визуализатор.</p>
        <p>Кроме того, я увлекаюсь психологией и соционикой.</p>
        <p>Помимо всего этого, я — студент <a href="http://ifmo.ru">ИТМО</a>, учусь на 3 курсе по специальности <a href="http://www.ifmo.ru/spec/25/spec_25.htm">«Информационные системы и технологии»</a>.</p>
    </section>
</article>
...
<article>
    ...
    <section>
        <p>Давно думал, какую взять символику для этой версии своего сайта.
...
<article>
    ...
    <section>
        <p>В общем-то, блога у меня больше нет.</p>
        ...
        <p>В любом случае, летом я верну сюда те старые заметки, что устраивают меня самого.</p>
